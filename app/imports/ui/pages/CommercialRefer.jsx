      ...
      <div className={'body'}>
        ...
        <div className='whiteBack'>
          <Grid container textAlign={'center'} verticalAlign={'middle'} stackable columns={2}>
            <Grid.Column>
              <Header as={'h1'}>Timely Refrigeration Services and Repairs</Header>
              {/* eslint-disable-next-line */}
              <Header as={'h3'}>Remedy Heating & Cooling understands the urgency attached to refrigeration and ice machines - especially for schools, hotels, restaurants, and grocery stores.  We service, install, and repair ice machines, walk-in coolers, refrigerators, and other refrigeration equipment.</Header>
              {/* eslint-disable-next-line */}
              <Header as={'h3'}>Call today for more information!</Header>
            </Grid.Column>
            <Grid.Column>
              <Image src={'/images/fan.jpeg'} size={'large'} verticalAlign={'middle'} />
            </Grid.Column>
          </Grid>
        </div>
      </div>
