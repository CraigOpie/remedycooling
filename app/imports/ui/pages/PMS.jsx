      ...
      <div className={'body'}>
        ...
        <div className='whiteBack'>
          <Grid container textAlign={'center'} verticalAlign={'middle'} stackable columns={2}>
            <Grid.Column>
              <Header as={'h1'}>Our Maintenance Plans Save Money</Header>
              {/* eslint-disable-next-line */}
              <Header as={'h3'}>As HVAC systems age, they lose efficiency throughout the refrigeration cycle. Our qualified HVAC technicians are trained to identify system and environmental hazards that may affect the system's efficiency and taylor a preventative maintenance schedule to meet the system needs and extend the life of the equipment.</Header>
              {/* eslint-disable-next-line */}
              <Header as={'h3'}> Preventative Maintenance increases the lifespan and efficiency of the system to raise reliability and correct small issues before they become large costly ones.  Most major failures occur after demonstrating symptoms that the equipment is starting to go bad.  Our qualified HVAC technicians recognize and identify these early warning signs and take action before the failure occurs.  Reach out for your free quote today!</Header>
            </Grid.Column>
            <Grid.Column>
              <Image src={'/images/maintenance.jpeg'} size={'large'} verticalAlign={'middle'} />
            </Grid.Column>
          </Grid>
        </div>
      </div>
