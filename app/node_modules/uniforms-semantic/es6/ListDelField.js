...
function ListDel(_a) {
    ...
    return (React.createElement("i", Object.assign({}, filterDOMProps(props), { className: classnames('ui', props.className, limitNotReached ? 'link' : 'disabled', 'fitted close icon'), onClick: () => {
