...
function ListDel(_a) {
    ...
    return (react_1.default.createElement("i", tslib_1.__assign({}, uniforms_1.filterDOMProps(props), { className: classnames_1.default('ui', props.className, limitNotReached ? 'link' : 'disabled', 'fitted close icon'), onClick: function () {
